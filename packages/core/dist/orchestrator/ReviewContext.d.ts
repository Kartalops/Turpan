...
export declare function createReviewContext(projectRoot: string, fingerprint: ProjectFingerprint, config: TurpanConfig, options?: {
    deepAnalysis?: boolean;
    uiAnalysis?: boolean;
    fixMode?: boolean;
    signal?: AbortSignal;
...
export declare function elapsedMs(ctx: ReviewContext): number;
//# sourceMappingURL=ReviewContext.d.ts.map