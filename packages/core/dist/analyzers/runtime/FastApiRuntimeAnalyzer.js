...
export class FastApiRuntimeAnalyzer {
    id = 'fastapi-runtime';
    ...
    async detectAppEntrypoint(projectRoot) {
    ...
    async runImportCheck(projectRoot, entrypoint) {
        const findings = [];
        const errors = [];
        if (!entrypoint) {
    ...
    async probeEndpoints(projectRoot, entrypoint) {
        const findings = [];
        const probes = [];
    ...
    async analyzeFastApiStatic(projectRoot, entrypoint) {
        const findings = [];
...
//# sourceMappingURL=FastApiRuntimeAnalyzer.js.map