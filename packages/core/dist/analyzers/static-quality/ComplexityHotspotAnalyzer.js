...
export class ComplexityHotspotAnalyzer {
    ...
    findNestedConditionals(content, lines) {
        const results = [];
        const ifStack = [];
...
//# sourceMappingURL=ComplexityHotspotAnalyzer.js.map