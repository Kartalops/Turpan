 ...
 */
export declare function buildPluginContext(projectRoot: string, fingerprint: ProjectFingerprint, config: Partial<TurpanConfig>, signal?: AbortSignal): PluginContext;
