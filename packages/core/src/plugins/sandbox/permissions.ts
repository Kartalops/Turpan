 ...
 */
export const LOCAL_TRUSTED_DEFAULT_PERMISSIONS: PluginPermission[] = [
  'read-project-files',
  'read-package-metadata',
  'run-analysis-only',
  'propose-fixes',
 ...
 */
export const EXTERNAL_UNTRUSTED_DEFAULT_PERMISSIONS: PluginPermission[] = [
  'read-package-metadata',
  'run-analysis-only',
];
...
): { granted: boolean; missing: PluginPermission[] } {
