...
export class BillingScenario {
    ...
    async checkComparisonTable(ctx, steps, screenshots) {
        const start = Date.now();
    ...
    async checkCheckoutButtons(ctx, steps, screenshots) {
        const findings = [];
        const start = Date.now();
...
//# sourceMappingURL=BillingScenario.js.map