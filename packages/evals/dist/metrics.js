export function computeQualityMetrics(cases, runs) {
...
export function computeQualityBySeverity(cases, runs) {
...
export function computeQualityByCategory(cases, runs) {
...
export function computeCalibration(findings, bucketSize = 10) {
    const buckets = [];
...
export function evaluateV1Gates(cases, runs, gates) {
...
function filterCategorySeverity(cases, runs, category, severity) {
    const scopedCases = cases.map((testCase) => ({
        ...testCase,
...
function toQualityMetrics(truePositive, falsePositive, falseNegative) {
...
function minGate(gate, target, actual) {
    return { gate, target, actual, passed: actual >= target };
}
function maxGate(gate, target, actual) {
    return { gate, target, actual, passed: actual <= target };
}
